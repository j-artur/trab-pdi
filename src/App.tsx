            ...
            <Match when={selectedTransformation() === 'scale'}>
              <label>
                ...
                <input
                  ...
                  onInput={e => {
                    setTransformCfg('scale', 'x', Number(e.currentTarget.value))
                  }}
                />
              </label>
              <label>
                ...
                <input
                  ...
                  onInput={e => {
                    setTransformCfg('scale', 'y', Number(e.currentTarget.value))
                  }}
                />
              </label>
            </Match>
            ...
            <Match when={selectedTransformation() === 'shear'}>
              <label>
                ...
                <input
                  ...
                  onInput={e => {
                    setTransformCfg('shear', 'x', Number(e.currentTarget.value))
                  }}
                />
              </label>
              <label>
                ...
                <input
                  ...
                  onInput={e => {
                    setTransformCfg('shear', 'y', Number(e.currentTarget.value))
                  }}
                />
              </label>
            </Match>
